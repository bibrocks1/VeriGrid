...
// Visual bar + status stamp for a cluster's confidence score. Thresholds are
// imported from lib/constants so this always reflects the backend's actual
// scoring rules (candidate ≥ 25, verified ≥ 60) rather than a hardcoded copy.
  ...
  return (
    <div>
      ...
      <div className="relative mt-3 h-2 w-full overflow-hidden rounded-full bg-current/10">
        ...
        />
        <div
          className="absolute top-0 h-full w-px bg-current/40"
