...
export default function VerificationExplainer() {
  ...
  return (
    <div className="rounded-sm border border-line-dark/60 bg-ink-2/60 p-6 sm:p-8">
      <p className="font-mono text-xs uppercase tracking-[0.14em] opacity-60">
      ...
      <div className="mt-6 flex flex-wrap items-center justify-between gap-4">
        <p className="font-mono text-sm tabular-nums opacity-80">
          ...
          {status === "verified" && (
            <span className="ml-2 text-verified">
        ...
        <button
          ...
          className="rounded-sm bg-amber px-4 py-2 font-mono text-xs uppercase tracking-[0.1em] text-ink transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-40"
        >
